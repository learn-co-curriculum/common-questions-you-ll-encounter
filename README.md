...
**What is it**: Problems with the platform and workflow (lights/IDE/empty cloned directory/etc)  
**Resolution**: Solve the problem for the student or if they can keep moving on in the curriculum, tell them to just keep going.     
